# 20241109 Kinscherf BMMB852 Homework 10
#assumes installation of micromamba bioinfo conda environment and bio code bioinformatics toolbox
...
usage:
	...
	@echo "make all	# run genome, download, trim, index, align targets"
...
all: genome index download trim align vcf index_vcf
