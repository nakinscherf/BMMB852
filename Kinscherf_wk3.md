...
See hw3_img1.png (https://github.com/nakinscherf/BMMB852/blob/main/hw3_img1.png)
...
See hw3_img2.png (https://github.com/nakinscherf/BMMB852/blob/main/hw3_img2.png), hw3_img2.png(https://github.com/nakinscherf/BMMB852/blob/main/hw3_img3.png) (strand flipped for same region; look @ start/stop codon placement relative to beginning & end of visible genes).
...
code intervals.gff
```
Created CDS features in two separate chromosomes. File uploaded to repository (https://github.com/nakinscherf/BMMB852/blob/main/intervals.gff).
Loaded intervals.gff into IGV with Agrobacterium tumefaciens reference sequence from NCBI dataset. See hw3_img4.png (https://github.com/nakinscherf/BMMB852/blob/main/hw3_img4.png) and hw3_img5.png (https://github.com/nakinscherf/BMMB852/blob/main/hw3_img5.png).

Creation of GFF file that functions in IGV successful.